        ...
        <div className="container mx-auto px-4 py-2 lg:py-6 lg:px-8">
          <nav className={styles.navbar}>
            <div className="lg:hidden">
              <button className="block w-10" onClick={(e) => handleMenu(e)} type="button">
                <img className="w-10" src="/images/icons/menu.svg" alt="" />
              </button>
            </div>
            ...
            <div className={`${styles['navbar-collapse']} ${showNavbar ? styles.show : ""}`}>
              <div className="cursor-pointer lg:none" onClick={(e) => handleMenu(e)}>
                <img src="/images/icons/close_white.svg" alt="" />
              </div>
